...
export const teamCarouselSection = {
  ...
  heading: ["The minds behind ", "every weld"] as const,
  description:
    "Engineers, fabricators and quality leads who turn pressure-vessel drawings into code-stamped reality — hover to read what each of them owns.",
};
