      ...
      <Container size="wide">
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-12 lg:gap-14">
          <motion.figure
            ...
            className="group relative lg:col-span-6 overflow-hidden rounded-[18px] lg:rounded-[22px] shadow-[0_30px_70px_-40px_rgba(0,0,0,0.35)]"
          >
